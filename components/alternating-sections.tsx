        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              {/* Copy side */}
              <div>
                <div className="inline-block bg-[#1A1A1A] text-[#F6FF52] text-xs font-bold px-3 py-1 rounded-full mb-4">
                  {s.tag}
                </div>
                ...
                <a
                  href={s.cta.href}
                  className="inline-flex items-center gap-2 bg-[#F6FF52] text-black font-bold px-6 py-3.5 rounded-full hover:bg-[#ECFD13] transition-colors"
                >
