export default function FinalCta() {
  return (
    <section className="py-24 bg-[#99FCA5]">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <a
            href="#explore"
            className="flex items-center justify-center gap-2 border-2 border-[#1A1A1A] text-[#1A1A1A] font-bold px-8 py-4 rounded-full hover:bg-[#5DFB84] transition-colors text-lg"
          >
